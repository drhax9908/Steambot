...
namespace SteamBot
{
    public class Configuration
    {
        ...
        /// <summary>
        /// Gets or sets YOUR API backpack key.
        /// </summary>
        /// <value>
        /// The API key you have been assigned by backpack.tf. If you do not have 
        /// one, it can be requested from backpack.tf at their Web API Key page. This
        /// is required and the bot(s) will not work without an API Key. 
        /// </value>
        public string ApiKeyBackPack { get; set; }
        ...
        /// <summary>
        /// Gets or sets a value indicating the password of the database.
        /// </summary>
        /// <value>
        /// <c>true</c> to make the bots start on program load; otherwise,
        /// <c>false</c> to not start them.
        ...
        /// <summary>
        /// Gets or sets a value indicating the name of the database.
        /// </summary>
        /// <value>
        /// <c>true</c> to make the bots start on program load; otherwise,
        /// <c>false</c> to not start them.
        ...
        /// <summary>
        /// Gets or sets a value indicating the steam ID for the administrator.
        /// </summary>
        ...
        public class BotInfo
        {
            ...
            public int BotGameUsage { get; set; }
